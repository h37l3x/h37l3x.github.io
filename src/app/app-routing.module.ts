...
import { GenerateMemeComponent } from './components/research-projects/children/generate-meme/component';
...
const routes: Routes = [
  ...
  {
    path: 'research-projects/generate-meme',
    component: GenerateMemeComponent, data: { state: 'research-projects' }
  },
  {
